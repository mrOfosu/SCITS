  ...
  const resp = await fetch(CHAT_URL, {
    ...
    body: JSON.stringify({
      ...
      complaints_context: complaintsContext?.map((c) => ({
        ...
        escalation_level: (c as any).escalation_level || 0,
        current_handler_role: (c as any).current_handler_role || null,
        escalated_at: (c as any).escalated_at || null,
        escalation_reason: (c as any).escalation_reason || null,
      })) || [],
    }),
    signal,
  });
