      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6 min-w-0">
          <Card className="shadow-elevation-sm">
            <CardHeader>
              <div className="flex items-start justify-between gap-4 flex-wrap gap-3">
                <div className="min-w-0" className="min-w-0">
                  <CardTitle className="break-words" className="text-lg tracking-tight break-words">{complaint.subject}</CardTitle>
